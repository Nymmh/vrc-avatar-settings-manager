...
ASM is proprietary software with source available for reference. By using ASM, you agree to the [End-User License Agreement (EULA)](./README/eula.md).
...
This allows your customers to easily load and use the configurations you've created. For more details, see Section 3.2 of the [EULA](./README/eula.md#32-commercial-use-of-exported-configurations).
