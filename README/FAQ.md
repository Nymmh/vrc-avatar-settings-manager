...
Yes! Avatar creators are welcome to include ASM-exported configurations and presets with their commercial avatar products. When doing so, please provide attribution by crediting Avatar Settings Manager and linking to the Github Repo (https://github.com/Nymmh/vrc-avatar-settings-manager) or Jinxxy (https://jinxxy.com/Nymh/ASM). This allows your customers to easily load and use the configurations you've created. See Section 3.2 of the [EULA](./terms.md#32-commercial-use-of-exported-configurations) for complete details.
